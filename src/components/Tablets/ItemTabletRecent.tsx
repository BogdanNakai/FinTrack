  ...
  return (
    <>
      {listTransaction.map((e, i: any) =>
        i < 5 ? (
          <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative py-2.5 bg-white border-t-0 border-r-0 border-b-[0.4px] border-l-0 border-slate-500">
